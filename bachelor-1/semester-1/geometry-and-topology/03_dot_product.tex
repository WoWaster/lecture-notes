...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
        \draw [-Latex] (0,0) -- node[above,sloped] {$\va$}  (1,2) ;
        \draw [-Latex] (1,2) -- (4,2);
        \draw [-Latex] (0,0) -- node[below,sloped] {$\vb$} (3,0);
        \draw [-Latex] (3,0) -- (4,2);
        \draw [-Latex, red] (0,0) -- node[above,sloped] {$\va + \vb$} (4,2);
    \end{tikzpicture}
\end{figure}
...
\begin{corollary}
    \[\frac{(\va_1+\va_2, \vb)}{|\vb|^2} \vb =
        \frac{(\va_1,\vb)}{|\vb|^2} \vb + \frac{(\va_2,\vb)}{|\vb|^2} \vb =
