...
\begin{proposition}
    Пусть $V$ евклидово. Тогда $\rho: \underset{V \rightarrow V^*}{w \mapsto \rho w}$ -- изоморфизм линейных пространств.
\end{proposition}
...
\begin{proposition}
    Пусть $V$ унитарное. Тогда $\rho: \underset{V \rightarrow V^*}{w \mapsto \rho w}$ -- полулинейная биекция.
\end{proposition}
