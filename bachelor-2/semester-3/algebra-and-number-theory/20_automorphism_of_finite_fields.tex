...
\begin{proposition}
    Пусть $\sigma: \ K \hookrightarrow F$ -- вложение, $L = K(x)$ -- простое алгебраическое расширение,  $f = \Irr_Kx, \ y_1, \ldots, y_n$ -- все корни $f^{\sigma}$ в $F$. Тогда у $\sigma$ есть ровно $n$ продолжений $\sigma_1, \ldots, \sigma_n$ на $L$, причем $\sigma_i(x) = y_i, \ i = 1, \ldots, n$.
\end{proposition}
