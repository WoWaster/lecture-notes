...
\begin{definition} [Алгебра]
    Говорят, что задана алгебра над полем $K$, если задано множество $A$, бинарные операции +, $\times$ на нем и отбражение $\cdot: K \times  A \to A$, т.ч.:
    \begin{enumerate}
        \item $(A,+, \times)$ -- кольцо
...
\end{gather*}
$(\End \ V, +, \cdot)$ — линейное пространство над полем $K$. Наконец,
...
\begin{definition} [Эквивалентность матриц оператора в разных базисах]
    ...
    \begin{gather*}
        A= (C^{-1})^{-1}A'C^{-1} \text{ симметричность} \\
