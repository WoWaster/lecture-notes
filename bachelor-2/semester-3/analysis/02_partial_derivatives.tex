...
\chapter{Частные производные}
    ...
    %\begin{wrapfigure}{l}{0.25\textwidth} 
        \includegraphics[width=0.05\linewidth]{chikulya_finally.pdf}
    %\end{wrapfigure}.
        \begin{gather*}
        ...
        \begin{longProof}
            \begin{gather*}
                ...
                K_r(x_i^0, x_j^0) = \{ (x_i - x^0_i)^2 + (x_j-x_j^0)^2 < r^2 \} \\
                ...
                F^{\prime\prime}_{x_i x_j}(x_i^0, x_j^0) = F^{\prime\prime}_{x_j x_i}(x_i^0, x_j^0)
            \end{gather*}
            \[
...
\end{gather*}
    ...
    \end{gather*}
    \begin{theorem}[О сложной функции специального вида]
    \begin{gather*}
    ...
    \begin{theorem}
        ...
        \end{longProof}
            \[ (1), (2), (3) \implies d^r f(X_0,H) = \sum_{\alpha: |\alpha| = r} C^\alpha_r \partial^\alpha f(X_0) H^\alpha =
             ...
             \begin{example}[Вычисление второго диференциала]
            ...
            \end{gather*}
               \[ (7) \implies d^2 f(X_0, H)= \sum_{i<j} 2 f^{\prime\prime}_{x_ix_j}(X_0) h_i h_j + \sum^n_{k=1}f^{\prime\prime}_{x_kx_k}(X_0)h^2_k \textcolor{red}{ =} \] 
...
\begin{gather*}
    ...
    \frac{F(x+h) - F(x)}{h} \underset{h \to 0}{\rightarrow} F^\prime(x) = \begin{bmatrix}
     ...
     \end{bmatrix} \tag{2} \end{gather*}
        ...
        \[ F \in C([a,b]) \Leftrightarrow f_k \in C([a,b]) \quad 1 \leq k \leq n \] 
