...
\end{proof}
% TODO: Геодезическая кривизна, вероятно будет на следующей паре, проверить что этот текст не нужен
% Есть поверхность и кривая на ней.
% Есть вектор кривизны на поверхности.
% Если этот вектор спроецировать на вектор нормали, то это будет нормальная кривизна в направлеии.
% Если спроецировать этот вектор на .., то это будет геодезическая кривизна.
% $k_g$ зависит только от I формы.

% линии с $k_g = 0$ локально кратчайшие
\end{document}