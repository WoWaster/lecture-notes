...
Считаем, что ориентация $\overrightarrow{S}$ задана параметризацией $f$, т.е. для каждой точки $M_0 = f(u_0, v_0) \in S$ нормаль $n(M_0)$ удовлетворяет условию $n(M_0) \upuparrows f'_u(u_0, v_0) \times f'_v(u_0, v_0)$, т.е. она они сонаправлены.
