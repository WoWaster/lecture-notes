...
\begin{document}
% Здесь то, что я раньше понаписал, сейчас я это раскидал так, как мне кажется наиболее логично, оставляю на всякий случай, если что, потом удалю.
...
%        \end{prooftree}
% \end{align*}
\chapter{Секвенциальное исчисление высказываний (СИВ)}\marginpar{21.02.23}
\section{Исчисления}
